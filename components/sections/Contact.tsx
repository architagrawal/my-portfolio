    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div>
              <h3 className="text-2xl font-semibold mb-6 text-center text-foreground">Contact Information</h3>
              <div className="grid sm:grid-cols-2 gap-6">
                <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-colors bg-background/50 backdrop-blur-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <a href="mailto:ARCHITAGRAWAL000@GMAIL.COM" className="text-muted-foreground hover:text-blue-600 transition-colors">
